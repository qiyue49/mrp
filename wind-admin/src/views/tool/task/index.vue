  ...
  data() {
    return {
      ...
      rules: {
        ...
        executeClass: [{ required: true, message: '请输入执行类！' }],
        loadWay: [{ required: true, message: '请选择加载方式！' }],
        isConcurrent: [{ required: true, message: '请选择是否同步！' }],
        methodName: [{ required: true, message: '请输入方法名！' }],
