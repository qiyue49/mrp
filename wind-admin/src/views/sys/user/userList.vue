  ...
  <el-row :gutter="40">
    ...
    <el-col :span="18">
      <div class="app-container">
        ...
        <el-dialog v-model="dialogFormPasswordVisible" draggable class="dialog-title" title="修改密码">
        ...
        <el-dialog v-model="dialogFormRolesVisible" draggable class="dialog-title" title="设置角色">
          <el-transfer
            v-model="userRoleIds"
            :filterable="true"
