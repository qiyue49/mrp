...
public class JaxbMapper {
     ...
     * Xml->Java Object.
     */
    public static <T> T fromLocation(String xmlLocation, Class<T> clazz) {
        try {
            if (!FileUtils.isAbsolutePath(xmlLocation)) {
                xmlLocation = JaxbMapper.class.getClassLoader().getResource(xmlLocation).getPath();
            }
