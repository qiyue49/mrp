package com.sunseagear.common.query.resolver;

import com.sunseagear.common.query.annotation.PageableDefaults;
 ...
 *     test_page.number=1    页码 从1开始
 *     test_sort.a.b=desc
 *     test_sort.c=asc
 *     foo_page.size=10  分页大小
 *     foo_page.number=1    页码 从1开始
 *     foo_sort.a.b=desc
 *     foo_sort.c=asc
 *
 *   排序默认按照请求时顺序排
