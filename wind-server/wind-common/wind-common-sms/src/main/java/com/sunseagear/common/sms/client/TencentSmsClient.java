 ...
 * @description: 腾讯客户端操作 * @date: 2017年8月11日 下午9:55:00
...
public class TencentSmsClient implements ISmsClient {
    ...
    public SmsResult send(String phone, String template, Map<String, Object> datas) {
        ...
        Object[] objs = datas.values().toArray();
        String[] templateParam = Arrays.copyOf(objs, objs.length, String[].class);
    ...
    private SendSmsResponse send(String templateId, String phone, String[] templateParam) throws TencentCloudSDKException {
        ...
        /* 模板参数: 若无模板参数，则设置为空 */
        //String[] templateParamSet = {"22335","5"};
